...
class GetChattingListUseCase @Inject constructor(
    ...
    suspend operator fun invoke(list: List<String>, userId: String): List<ChattingListEntity> {
        return chattingListRepository.getChattingListByGroupIdList(list, userId)
    }
}